...
import {ProofBindingLibV2} from "../libraries/ProofBindingLibV2.sol";
...
contract MorrowMarketV2 is ReentrancyGuard {
    ...
    function fundReservation(
        ...
        bytes32 eventKey = ProofBindingLibV2.reservation(proof, logIndex, terms, SOURCE_VAULT);
        ...
        nonReentrant
    {
        ...
        bytes32 eventKey = ProofBindingLibV2.outcome(proof, logIndex, sale.terms, SOURCE_VAULT, true);
        consume(eventKey);
    ...
    {
        MarketTypes.Sale storage sale = boundSale(saleId);
        bytes32 eventKey = ProofBindingLibV2.outcome(proof, logIndex, sale.terms, SOURCE_VAULT, false);
        consume(eventKey);
